...
session_list = [
  {course_id: "2", time: Time.now.to_s, date: Date.parse(Time.now.to_s)},
  {course_id: "1", time: Time.now.to_s, date: Date.parse(Time.now.to_s)},
  {course_id: "3", time: Time.now.to_s, date: Date.parse(Time.now.to_s)},
]
